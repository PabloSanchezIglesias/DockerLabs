...
Una vez obtenidas las credenciales válidas (`russoski:iloveme`), procedí a probar la conexión hacia el servidor SSH para intentar autenticarme en el sistema. Al introducir la contraseña, el logueo funcionó correctamente y logré obtener una shell interactiva como el usuario `russoski`.
